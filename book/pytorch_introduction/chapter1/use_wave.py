...
def read_wav(file_path):
    ...
    print(f"channels:{channels}, sampwidth:{sampwidth}, framerate:{framerate}, frames:{frames}, durations:{frames/framerate}(s)")
    ...
    int_data = [int.from_bytes(data[index:index+2], "little",signed=True) for index in range(0, len(data), 2)]
