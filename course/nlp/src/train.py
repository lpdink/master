    ...
    try:
        for epoch in range(config.epochs):
            ...
            for idx, (src, dst) in enumerate(train_loader):
                ...
                # logging.info(dst)
                # logging.info(dst.shape)
                # logging.info(dst_mask)
                # logging.info(dst_mask.shape)
                # logging.info(src_padding_mask)
                # logging.info(src_padding_mask.shape)
                # logging.info(dst_padding_mask)
                # logging.info(dst_padding_mask.shape)
                # breakpoint()
